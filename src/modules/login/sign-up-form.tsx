      ...
      <Card className="border-0 shadow-2xl shadow-black/5">
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="button" className="w-full h-11 font-medium group" disabled={isLoading} onClick={signUp}>
              {isLoading ? (
          ...
          <div className="text-center text-sm text-muted-foreground">
            ...
            <button className="text-accent hover:text-accent/80 font-medium">Sign in</button>
          </div>
        </CardContent>
      </Card>
    </div>
